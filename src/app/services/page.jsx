...
export const services = [
  // this connect with the SlugPage
  ...
  {name: "Wedding Planning",
    ...
    category: "decoration",
    price: "N/A",
    visual: <Image src = {'/img/wedding.jpg'} alt = "Event Decoratio" width = {200} height = {100}/>
  },
  ...
  {name: "House Opening",
    ...
    category: "decoration",
    price: "N/A",
    visual: <Image src = {'/img/house-open2.jpg'} alt = "house openning" width = {200} height = {100}/>
  },
  ...
  {name: "Birthday Planning",
    ...
    category: "roasted",
    price: "N/A",
    visual: <Image src = {'/img/birthday.jpg'} alt = "Birthday" width = {200} height = {100}/>
  },
  ...
  {name: "Coperate Event",
    ...
    category: "decoration",
    price: "N/A",
    visual: <Image src = {'/img/coperat4.jpg'} alt = "Roasted Fish" width = {200} height = {100}/>
  },
  ...
  {name: "Fried Rice And Chicken Food Pack",
    description: ["Packs of fried rice with chicken about to be delivered to a client from Deesh Catering and Event "],
    category: "Food pack",
    price: "N/A",
    visual: <Image src = {'/img/food packs.Food pack'} alt = "fried rice" width = {200} height = {100}/>
  },
...
export default function OurServices() {
  return (
      <div className=''>
      <p className='flex justify-center pt-3 font-extrabold text-orange-700 text-4xl'>Some of the events we make easy and memorable for you</p>
